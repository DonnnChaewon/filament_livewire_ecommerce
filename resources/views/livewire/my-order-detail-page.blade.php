                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        @php
                            ...
                            if($order->status == 'processing') $status = '<span class="bg-yellow-500 py-1 px-3 rounded text-white shadow">New</span>';
                            if($order->status == 'processing') $status = '<span class="bg-green-500 py-1 px-3 rounded text-white shadow">New</span>';
                            if($order->status == 'delivered') $status = '<span class="bg-green-700 py-1 px-3 rounded text-white shadow">New</span>';
                            if($order->status == 'cancelled') $status = '<span class="bg-red-500 py-1 px-3 rounded text-white shadow">New</span>';
                        @endphp
                        {!! $status !!}
                    </div>
                </div>
